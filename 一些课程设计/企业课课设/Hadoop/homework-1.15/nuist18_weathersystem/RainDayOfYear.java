...
/**
 * 统计每年的下雨天数：从weathers表中读取数据 ，统计出每年下雨天数，并写入表result中
 *
 */
public class RainDayOfYear {
	...
	static class TempMinReducer extends TableReducer<Text, FloatWritable, NullWritable> {
		...
		protected void reduce(Text key, Iterable<FloatWritable> values,
			...
			byte[] c1 = Bytes.toBytes("rainday");
			Put put = new Put(row);
			put.addColumn(family, c1, Bytes.toBytes(day));
			// 输出
